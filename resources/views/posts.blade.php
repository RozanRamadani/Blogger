                    ...
                    <div class="grid lg:grid-cols-2 gap-8 items-center">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between pt-4">
                                <a href="/posts?author={{ $featured->author->username }}" class="flex items-center space-x-3 group/author">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm text-charcoal-500 dark:text-charcoal-400">
                                            {{ $featured->created_at->format('d M Y') }} • {{ ceil(str_word_count($featured->body) / 200) }} menit baca
                                        </div>
                                    </div>
                                </a>
