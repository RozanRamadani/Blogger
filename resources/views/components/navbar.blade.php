 <nav class="bg-gray-800" x-data="{ isOpen: false }">
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
        <x-nav-link class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white" href="/" :active="request()->is('/')">Home</x-nav-link>
        <x-nav-link class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white" href="/posts" :active="request()->is('/')">Blog</x-nav-link>
        <x-nav-link class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white" href="/about" :active="request()->is('/')">About</x-nav-link>
        <x-nav-link class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white" href="/kontak" :active="request()->is('/')">Kontak</x-nav-link>
      </div>
