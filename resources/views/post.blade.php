        ...
        <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
            <article
                ...
                <header class="mb-4 lg:mb-6 not-format">
                    <a href="/posts" class="text-sm font-medium text-blue-600 hover:underline">&laquo; Back to all
                        posts</a>
                            ...
                            <div>
                                ...
                                <div class="flex justify-between items-center mb-5 text-gray-500">
                                    <a href="/posts?category={{ $post->category->slug }}">
                                        <span
                                            class="bg-{{ $post->category->color }}-100 text-primary-800 text-xs font-medium inline-flex items-center px-2 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800">
                                            {{ $post->category->name }}
                                        </span>
                                    </a>
                                    <span class="text-sm px-1">{{ $post->created_at->diffForHumans() }}</span>
                                </div>
                            </div>
                        </div>
                    </address>
