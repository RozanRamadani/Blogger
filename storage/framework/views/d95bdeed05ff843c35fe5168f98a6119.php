    ...
    <details class="mt-6 p-6 bg-cream-50 dark:bg-charcoal-900/50 rounded-xl border-2 border-primary-100 dark:border-primary-900/30">
        ...
        <div class="mt-4 text-sm text-charcoal-700 dark:text-cream-300 space-y-3">
            ...
            <ol class="list-decimal list-inside space-y-2 ml-2">
                ...
                <li>Visit <a href="https://giscus.app" target="_blank" class="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-medium underline">giscus.app</a></li>
                <li>Enter your repository name: <code class="bg-cream-100 dark:bg-charcoal-800 text-primary-700 dark:text-primary-300 px-2 py-1 rounded font-mono text-xs">RozanRamadani/Blogger</code></li>
                <li>Copy the generated script configuration values</li>
                <li>Update this component with your <code class="bg-cream-100 dark:bg-charcoal-800 text-primary-700 dark:text-primary-300 px-2 py-1 rounded font-mono text-xs">data-repo-id</code> and <code class="bg-cream-100 dark:bg-charcoal-800 text-primary-700 dark:text-primary-300 px-2 py-1 rounded font-mono text-xs">data-category-id</code></li>
            </ol>
            <div class="mt-4 p-3 bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-lg">
                <p class="text-xs text-primary-900 dark:text-primary-300 flex items-start">
                    <svg class="w-4 h-4 mr-2 flex-shrink-0 mt-0.5 text-primary-500 dark:text-primary-400" fill="currentColor" viewBox="0 0 20 20">
