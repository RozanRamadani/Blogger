...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['categories', 'tags', 'authors']));
...
foreach (array_filter((['categories', 'tags', 'authors']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
            ...
            <div>
                ...
                <select x-model="selectedAuthor" @change="applyFilters"
                    ...
                    <?php $__currentLoopData = $authors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($author->username); ?>" <?php echo e(request('author') == $author->username ? 'selected' : ''); ?>>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('searchComponent', () => ({
        ...
        selectedTag: '<?php echo e(request("tag")); ?>',
        selectedAuthor: '<?php echo e(request("author")); ?>',
        suggestions: [],
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\project1\resources\views/components/advanced-search.blade.php ENDPATH**/ ?>