            ...
            <article
                ...
                <header class="mb-8 lg:mb-10 not-format">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $post)): ?>
                        <a href="<?php echo e(route('articles.edit', $post->slug)); ?>" class="ml-4 inline-flex items-center text-sm px-3 py-1.5 rounded-lg bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 hover:bg-yellow-200 dark:hover:bg-yellow-800 transition-colors">
                        ...
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-3 mt-2 text-sm text-gray-600 dark:text-gray-400">
                                    <a href="/posts?category=<?php echo e($post->category->slug); ?>" class="group">
                                        <span class="px-3 py-1 rounded-full text-xs font-bold bg-<?php echo e($post->category->color); ?>-100 dark:bg-<?php echo e($post->category->color); ?>-900 text-<?php echo e($post->category->color); ?>-800 dark:text-<?php echo e($post->category->color); ?>-200 shadow-sm group-hover:shadow-md transition-all">
                ...
                <div class="prose prose-lg dark:prose-invert max-w-none">
                    <p class="lead text-xl text-gray-700 dark:text-gray-300 leading-relaxed"><?php echo e($post['body']); ?></p>
                </div>
                    ...
                    <div class="grid gap-6 md:grid-cols-3">
                        ...
                        <article class="group p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                            ...
                            <a href="/posts?category=<?php echo e($relatedPost->category->slug); ?>">
                                <span class="px-2 py-1 text-xs font-bold rounded-full bg-<?php echo e($relatedPost->category->color); ?>-100 dark:bg-<?php echo e($relatedPost->category->color); ?>-900 text-<?php echo e($relatedPost->category->color); ?>-800 dark:text-<?php echo e($relatedPost->category->color); ?>-200">
                            ...
                            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400 line-clamp-2">
                                <?php echo e(Str::limit($relatedPost->body, 80)); ?>

                            </p>
                            <div class="mt-3 flex items-center text-xs text-gray-500 dark:text-gray-400">
                                <span><?php echo e($relatedPost->author->name); ?></span>
