    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                <div class="ml-10 flex items-center space-x-6">
                    <a href="/" class="px-3 py-2 rounded-md text-sm font-medium hover:text-primary-600 dark:hover:text-primary-400 transition-colors <?php echo e(request()->is('/') ? 'text-primary-600 dark:text-primary-400 font-semibold' : 'text-gray-700 dark:text-gray-300'); ?>">
                        Home
                    </a>
                    <a href="/posts" class="px-3 py-2 rounded-md text-sm font-medium hover:text-primary-600 dark:hover:text-primary-400 transition-colors <?php echo e(request()->is('posts*') ? 'text-primary-600 dark:text-primary-400 font-semibold' : 'text-gray-700 dark:text-gray-300'); ?>">
                        Articles
                    </a>
                    <a href="/about" class="px-3 py-2 rounded-md text-sm font-medium hover:text-primary-600 dark:hover:text-primary-400 transition-colors <?php echo e(request()->is('about') ? 'text-primary-600 dark:text-primary-400 font-semibold' : 'text-gray-700 dark:text-gray-300'); ?>">
                        About
                    </a>
                    <a href="/kontak" class="px-3 py-2 rounded-md text-sm font-medium hover:text-primary-600 dark:hover:text-primary-400 transition-colors <?php echo e(request()->is('kontak') ? 'text-primary-600 dark:text-primary-400 font-semibold' : 'text-gray-700 dark:text-gray-300'); ?>">
                        Contact
                    </a>
                </div>
            </div>
        ...
        <div x-show="mobileMenuOpen" 
            ...
            <div class="space-y-1 px-2">
                <a href="/" class="block px-3 py-2 rounded-md text-base font-medium <?php echo e(request()->is('/') ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'); ?>">
                    Home
                </a>
                <a href="/posts" class="block px-3 py-2 rounded-md text-base font-medium <?php echo e(request()->is('posts*') ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'); ?>">
                    Articles
                </a>
                <a href="/about" class="block px-3 py-2 rounded-md text-base font-medium <?php echo e(request()->is('about') ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'); ?>">
                    About
                </a>
                <a href="/kontak" class="block px-3 py-2 rounded-md text-base font-medium <?php echo e(request()->is('kontak') ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'); ?>">
                    Contact
                </a>
            </div>
        </div>
...
<div class="h-16"></div>
<?php /**PATH C:\laragon\www\project1\resources\views/components/modern-navbar.blade.php ENDPATH**/ ?>